...
extern int GBALinkSendDataToPeerAtIndex(int index, const char *data, size_t size);
extern int GBALinkReceiveDataFromPeerAtIndex(int index, char *data, size_t maxSize);
...
Socket::Status SocketTCP::Send(const char* Data, std::size_t Size)
{
    ...
    if (Data && Size)
    {
        ...
        Sent = GBALinkSendDataToPeerAtIndex(0, Data, SizeToSend);
